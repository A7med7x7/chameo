...
TEMPLATE = "https://github.com/A7med7x7/reprogen.git"

@click.group()
def cli():
    """ReproGen CLI wrapper"""
    pass
...
def create(path, template, vcs_ref):
    ...
    if shutil.which("copier") is None:
        click.echo("copier executable not found. Install dependencies (pip install -e .) or 'pip install copier'")
        sys.exit(2)
